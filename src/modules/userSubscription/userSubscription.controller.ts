...
const createCheckout = catchAsync(async (req: Request, res: Response) => {
    try {
        ...
        const session = await userSubscriptionService.createCheckoutSession({
            user,
            planId,
            successUrl,
            cancelUrl
...
const stripeWebhook = catchAsync(async (req: Request, res: Response) => {
    ...
    try {
        ...
        const result = await userSubscriptionService.handleStripeWebhook(event);
    } catch (err: any) {
...
const verifyPayment = catchAsync(async (req: Request, res: Response) => {
    try {
        ...
        const result = await userSubscriptionService.verifyPayment(session_id);
